...
import com.pack.bookapp.databinding.ActivityPdfAddBinding;
...
public class PdfAddActivity extends AppCompatActivity {
    ...
    private FirebaseAuth firesbaseAuth;
        ...
        storageReference.putFile(pdfUri)
                .addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>(){
                    ...
                    public void onSuccess(UploadTask.TaskSnapshot taskSnapshot){
                        ...
                        Log.d(TAG, "onSuccess: gettong pdf url");

                        Task<Uri> uriTask = taskSnapshot.getStorage().getDownloadUrl();
                        while (!uriTask.isSuccessful());
                        String uploadedPdfUrl = ""+uriTask.getResult();

                        uploadPdfInfoToOb(uploadedPdfUrl, timestamp);
    ...
    private void uploadPdfInfoToOb(String uploadedPdfUrl, long timestamp) {
        Log.d(TAG, "uploadPdfToStorage: uploading to storage");

        progressDialog.setMessage("Uploading pdf info");

        String uid = firesbaseAuth.getUid();
